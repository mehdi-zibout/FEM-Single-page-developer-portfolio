const Socials = () => {
  return (
    <div className="mx-auto left-0 right-0 pb-5">
      <div className="flex flex-col tablet:flex-row items-center tablet:justify-between">
        <div className="text-m tablet:py-8  mb-5 tablet:mb-0">adamkeyes</div>
        <div className="flex justify-evenly tablet:py-8 ">
          <a href="https://github.com/mehdi-zibout">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="fill-white hover:fill-green cursor-pointer mx-3"
              width="25"
              height="24"
            >
              <path
          ...
          <a href="https://www.frontendmentor.io/profile/mehdi-zibout">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="fill-white hover:fill-green mx-3 cursor-pointer"
              width="25"
              height="24"
            >
